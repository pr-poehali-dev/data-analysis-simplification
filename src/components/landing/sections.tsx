...
export const sections = [
  ...
  },
  {
    id: 'about',
    title: 'О проекте.',
    content: 'Сайт создан студентами экономического факультета, как учебный проект по теме личных финансов и финансовой грамотности. Экономика повседневной жизни - ближе, чем кажется.',
    showButton: true,
